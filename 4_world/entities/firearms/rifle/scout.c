...
class SCOUT_CLO_BU0_MA0 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BU0_MA0; }
...
class SCOUT_CLO_BU1_MA0 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BU1_MA0; }
...
class SCOUT_CLO_BU1_MA1 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BU1_MA1; }
	override bool HasBullet () { return true; }
...
class SCOUT_CLO_BU0_MA1 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BU0_MA1; }
	override bool HasBullet () { return false; }
	override bool HasMagazine () { return true; }
	override bool IsJammed () { return false; }
	override bool IsRepairEnabled () { return true; }
...
class SCOUT_CLO_BUF_MA0 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BUF_MA0; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return false; }
	override bool IsJammed () { return false; }
	override bool IsRepairEnabled () { return true; }
...
class SCOUT_CLO_BUF_MA1 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_CLO_BUF_MA1; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return true; }
	override bool IsJammed () { return false; }
	override bool IsRepairEnabled () { return true; }
...
class SCOUT_JAM_BU1_MA0 extends WeaponStateJammed
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_JAM_BU1_MA0; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return false; }
...
class SCOUT_JAM_BU1_MA1 extends WeaponStateJammed
{
	...
	override int GetCurrentStateID () { return SCOUTStableStateID.SCOUT_JAM_BU1_MA1; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return true; }
	override bool IsJammed () { return true; }
	override bool IsBoltOpen () { return true; }
...
class Scout_Base : BoltActionRifle_Base
{
	...
	override void InitStateMachine()
	{
		...
		// regexp: [CLJ][01F][01]
		C00 = new SCOUT_CLO_BU0_MA0(this, NULL, RBLAnimState.DEFAULT);
		C10 = new SCOUT_CLO_BU1_MA0(this, NULL, RBLAnimState.DEFAULT);
		C01 = new SCOUT_CLO_BU0_MA1(this, NULL, RBLAnimState.DEFAULT);
		C11 = new SCOUT_CLO_BU1_MA1(this, NULL, RBLAnimState.DEFAULT);
		CF0 = new SCOUT_CLO_BUF_MA0(this, NULL, RBLAnimState.DEFAULT);
		CF1 = new SCOUT_CLO_BUF_MA1(this, NULL, RBLAnimState.DEFAULT);
		JF0 = new SCOUT_JAM_BU1_MA0(this, NULL, RBLAnimState.JAMMED);
		JF1 = new SCOUT_JAM_BU1_MA1(this, NULL, RBLAnimState.JAMMED);
	...
	override void OnDebugSpawn()
	{
		...
		{
			entity.GetInventory().CreateInInventory( "ACOGOptic" );
			entity.SpawnEntityOnGroundPos("Mag_Scout_5Rnd", entity.GetPosition());
		}
	}
};